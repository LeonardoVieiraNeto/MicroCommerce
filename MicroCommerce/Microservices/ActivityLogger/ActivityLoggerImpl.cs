...
namespace ActivityLogger
{
    public class ActivityLoggerImpl : IActivityLogger
    {
        ...
        private string GetEventDesc(CartEventTypeEnum type)
        {
            switch (type)
            {
                case CartEventTypeEnum.OrderAdded: return "Produto adicionado";
                case CartEventTypeEnum.OrderChanged: return "Produto alterado";
                case CartEventTypeEnum.OrderRemoved: return "Produto removido";
